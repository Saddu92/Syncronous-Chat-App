...
function Profile() {
  ...
  return (
    <div className="bg-[#1b1c24] h-[100vh] flex items-center justify-center flex-col gap-10">
      <div className="flex flex-col gap-10 w-[80-vw] md:w-max">
          ...
          >
            <Avatar className="h-32 w-32 md:w-48 md:h-48 rounded full overflow-hidden">
              {image ? (
                ...
                <div
                  className={`uppercase h-32 w-32 md:w-48 md:h-48 text-5xl border-[1px] flex flex items-center justify-center rounded-full ${getColor(
                    selectedColor
                  )}`}
                >
                  {firstName
